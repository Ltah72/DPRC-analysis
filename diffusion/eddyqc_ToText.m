...
cd([startdir '/derivatives/groups/' period '/diff_data/' PAR_NAME, '/dwi/eddyqc/']);
...
cd([startdir '/derivatives/groups/' period '/diff_data/' PAR_NAME, '/dwi/eddyqc/eddy_quad.qc/']);
...
cd([startdir '/derivatives/groups/' period '/diff_data/' PAR_NAME, '/dwi/']);
