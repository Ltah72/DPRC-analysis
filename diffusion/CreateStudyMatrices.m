function CreateStudyMatrices(excelFile,fileLocation, derivdir, groupname, period)
...
movefile('design_matrix.txt', [derivdir, '/groups/' period, '/diff_data/' groupname, '/stats_matrices']);
movefile('contrast_matrix.txt', [derivdir, '/groups/' period, '/diff_data/' groupname, '/stats_matrices']);
